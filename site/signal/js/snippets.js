...
export const SNIPPETS = [
  {
    id: 'stats',
    label: 'Stats bar',
    css: `.st{display:flex;flex-wrap:wrap;gap:24px 36px;margin:32px 0;padding:18px 0 16px;border-top:1px solid oklch(18% 0.01 50 / 0.18);border-bottom:1px solid oklch(18% 0.01 50 / 0.18)}
